	...
	<view class="content">
		...
		<view class="l-fixed">
			...
			<view class="l-head-title">
				我的<image @tap="$toast(`设置`)" class="l-icon-setting" src="../../static/icon/l-icon-setting.png" mode=""></image>
			</view>
		</view>
		...
		<view class="l-body">
			...
			<view class="l-body-head">
				<image class="l-head-img" src="../../static/u=147375.jpg" mode="aspectFill"></image>
